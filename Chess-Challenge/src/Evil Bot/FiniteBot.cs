...
public class EvilBot_3 : IChessBot
{
    ...
    public static class Evaluator
    {
        ...
        public static float PushOpponentKingToTheEdge(Board board)
        {
            ...
            return (Hdist + Wdist) + (14f - distBetweenKings);
        }
    }
    ...
    {
        float score = depthSearcher.DepthSearch(board, 4, 4, float.NegativeInfinity, float.PositiveInfinity, true);
